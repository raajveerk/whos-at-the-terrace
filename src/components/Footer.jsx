  ...
  return (
    <div className='flex flex-col w-full bg-black bg-opacity-30 backdrop-blur-md py-4 text-white'>
        <p className='flex justify-between md:text-md text-sm font-semibold'>
            ...
            <span className='text-center cursor-default'>'Who's at the Terrace?' made by <a href='https://www.instagram.com/raajveerkhattar/' target='_blank' rel='noopener noreferrer' className='underline text-teal-400 cursor-pointer'>Raajveer Khattar</a></span>
